...
//     // Generate current date and time in YYYY_MM_DD-HH_MM_SS format
//     const date = new Date();
...
//     const timestamp = `${year}_${month}_${day}-${hours}_${minutes}_${seconds}`;

//     cb(null, `${timestamp}.csv`); // Example: 2025_01_10-14_30_45-file.csv
//   },
// });
...
//     // Count the number of files (databaseCount)
//     const databaseCount = filenames.length;
...
//       lastUpdated,
//       databaseCount,
//       totalFiles: databaseCount, // Can be adjusted if necessary, but currently matches databaseCount
//     };
...
//     // Read the filenames from log.txt
//     fs.readFile(logFilePath, "utf8", (err, data) => {
//       if (err) {
//         return res.status(500).json({ message: "Error reading log file" });
//       }
  
//       // Split the log file content by new line and get the last 30 filenames
//       const filenames = data.trim().split("\n").slice(-30);
